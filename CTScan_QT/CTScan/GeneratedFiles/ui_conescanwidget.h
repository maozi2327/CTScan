...
public:
    ...
    void setupUi(QWidget *ConeScanWidget)
    {
        ...
        singleShotButton->setMinimumSize(QSize(220, 30));
        ...
        gridLayout_2 = new QGridLayout(coneScanTab);
        ...
        gridLayout_2->addWidget(coneScanSaveDirButton, 0, 0, 1, 1);
        ...
        gridLayout_2->addWidget(coneScanFileNameEdit, 0, 1, 1, 3);
        ...
        gridLayout_2->addWidget(coneScanLeakSamplePushButton, 1, 0, 1, 1);

        horizontalSpacer_3 = new QSpacerItem(157, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_2->addItem(horizontalSpacer_3, 1, 1, 1, 3);
        ...
        gridLayout_2->addWidget(coneScanGraduationStaticLabel, 2, 0, 1, 1);
        ...
        gridLayout_2->addWidget(coneScanMatrixComboBox, 2, 2, 1, 2);
        ...
        gridLayout_2->addWidget(coneScanFramesStaticLabel, 3, 0, 1, 1);
        ...
        gridLayout_2->addWidget(coneScanframesComboBox, 3, 2, 1, 2);
        ...
        gridLayout_2->addWidget(coneScanFrameAverageStaticLabel, 4, 0, 1, 1);
        ...
        gridLayout_2->addWidget(coneScanFrameAverageSpinBox, 4, 2, 1, 2);
        ...
        gridLayout_2->addWidget(coneScanBeginSampleButton, 5, 0, 1, 3);
        ...
        gridLayout = new QGridLayout(coneJointRotScanTab);
        ...
        gridLayout->addWidget(coneJointRotScanSaveDirButton, 0, 0, 1, 1);
        ...
        gridLayout->addWidget(coneJointRotScanfileNameEdit, 0, 1, 1, 3);
        ...
        gridLayout->addWidget(coneJointRotScanleakSamplePushButton, 1, 0, 1, 1);
        ...
        gridLayout->addWidget(coneJointRotScanGraduationStaticLabel, 2, 0, 1, 1);
        ...
        gridLayout->addWidget(coneJointRotScanMatrixComboBox, 2, 2, 1, 2);
        ...
        gridLayout->addWidget(coneJointRotScanFramesStaticLabel, 3, 0, 1, 1);
        ...
        gridLayout->addWidget(coneJointRotScanframesComboBox, 3, 2, 1, 2);
        ...
        gridLayout->addWidget(coneJointRotScanFrameAverageStaticLabel, 4, 0, 1, 1);
        ...
        gridLayout->addWidget(coneJointRotScanFrameAverageSpinBox, 4, 2, 1, 2);
        ...
        gridLayout->addWidget(coneJointRotScanBeginSampleButton, 5, 0, 1, 3);
